...
function ProfileCard({ name, bio, style }) {
  return (
    <div
    ...
    >
      ...
      <div className="w-full mt-5 px-3">
        <h3 className="text-[#2c3e50] text-center font-extrabold text-[30px] font-main-bold">
          {name}
        </h3>
        <p className="text-[15px] mt-3 text-center font-main">{bio}</p>
      </div>
    </div>
  );
}
...
export default function About() {
  return (
    <div className="bg-gradient-to-br from-[#f6f4fa] via-[#D7F9ED] to-[#EDEBFA]pt-12 pb-50 flex flex-col">
      <div>
        <h1 className="text-4xl text-[#3b2f2f] text-center font-bold mb-8">About Us</h1>
      </div>
